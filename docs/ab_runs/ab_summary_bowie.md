# Bowie A/B Summary (Baseline vs Progress Arc)

## Creation Details

- A run_id: `ds_dynamic_20260106T151045Z_7ebeb7ba`
- B run_id: `ds_dynamic_20260106T151107Z_9b41ca07`
- ds_mode: `dynamic`
- playlist_length: `30`
- fixed_piers:
  - `9dbf29a650b43f5ab7e0e836428000e1` | David Bowie - Life On Mars? | Hunky Dory | 3:56
  - `55979af56e425c605d2b8df5c6e1b5d7` | David Bowie - Warszawa | Low | 6:27
  - `00e9f570e6a9839e2844dd8410242fce` | David Bowie - Let's Dance | Let's Dance | 7:38
  - `328656b5878f1f293a4e981a0b3d961c` | David Bowie - Suffragette City | The Rise and Fall of Ziggy Stardust and the Spiders from Mars (1984 US CD release) | 3:24
...
| --- | --- | --- |
| experiments.progress_arc.enabled | False | True |
| experiments.progress_arc.weight | 0.25 | 0.25 |
| experiments.progress_arc.shape | linear | arc |

## Summary Metrics

| metric | A (baseline) | B (progress arc) |
| --- | ---: | ---: |
| min_transition | 0.6618666250931812 | 0.6721456808593727 |
| mean_transition | 0.8177522679245686 | 0.8262599445291751 |
| below_floor_count | 0 | 0 |
| soft_genre_penalty_hits | 436 | 476 |
| soft_genre_penalty_edges_scored | 61854 | 82994 |
...
- B improves mean transition similarity, indicating tighter edge quality without changing floors or weights.
- B raises the minimum transition score, suggesting fewer weak links in the bridge path.
- Both runs keep the same gating (transition_floor=0.20, bridge_floor=0.03) and segment pool settings, so differences are attributable to the progress-arc scoring term.
- B introduces a targeted progress curve, which should better enforce an arc toward the middle of each segment; overlap shows the experiment materially changes ordering/candidate choice.
