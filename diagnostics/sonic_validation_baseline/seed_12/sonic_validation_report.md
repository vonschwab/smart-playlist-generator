...
**Seed Track**: Built to Spill - Carry the Zero (245605408d2c8a532b13ca6a71b1352f)

**Date**: 2025-12-16 15:20:12
...
|--------|-------|-----------|--------|
| Score Flatness | 0.042 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.011 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.023668105660357708 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.009430179343977274 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.488 |
| TopK vs Random Gap | 0.575 |
