...
**Seed Track**: Bill Evans - Midnight Mood (5bbb5c1c2481bca6cfefde01466129e2)

**Date**: 2025-12-16 15:20:04
...
|--------|-------|-----------|--------|
| Score Flatness | 0.084 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.065 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.03494501844511977 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.05787837467066226 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 3.885 |
| TopK vs Random Gap | 0.894 |
