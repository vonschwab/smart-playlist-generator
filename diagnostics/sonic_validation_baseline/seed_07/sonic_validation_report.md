...
**Seed Track**: Jonny Nash - Eternal Life (5a363d4ef1cc05132b5577b93caddb96)

**Date**: 2025-12-16 15:19:59
...
|--------|-------|-----------|--------|
| Score Flatness | 0.040 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.030 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.014408765249441458 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.0248993866977697 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 0.918 |
| TopK vs Random Gap | 0.512 |
