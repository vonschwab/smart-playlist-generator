...
**Seed Track**: Weyes Blood - Andromeda (bee37246b632df7dcb8fd0d7d6194306)

**Date**: 2025-12-16 15:20:09
...
|--------|-------|-----------|--------|
| Score Flatness | 0.023 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.012 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.009440868293085991 | >= 0.05 | FAIL |
| Intra-Album Coherence | -0.0008122139429806996 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.167 |
| TopK vs Random Gap | 0.527 |
