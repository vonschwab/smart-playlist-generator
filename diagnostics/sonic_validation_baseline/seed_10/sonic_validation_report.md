...
**Seed Track**: Sufjan Stevens - Casimir Pulaski Day (5b78debacd8a7adfc6476fb4c2ad3315)

**Date**: 2025-12-16 15:20:06
...
|--------|-------|-----------|--------|
| Score Flatness | 0.018 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.014 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.005049319582116962 | >= 0.05 | FAIL |
| Intra-Album Coherence | -0.0037214995163158404 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.278 |
| TopK vs Random Gap | 0.656 |
