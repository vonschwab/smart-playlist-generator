...
**Seed Track**: TOPS - Way to be Loved (ac056e4b6b1bcdc36e576ee13659900f)

**Date**: 2025-12-16 15:19:56
...
|--------|-------|-----------|--------|
| Score Flatness | 0.022 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.011 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.018039117178319852 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.0059652382763608625 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.090 |
| TopK vs Random Gap | 0.596 |
