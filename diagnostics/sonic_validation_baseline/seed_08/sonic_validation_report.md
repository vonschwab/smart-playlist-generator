...
**Seed Track**: Marvin Gaye - Let's Get It On (217ca230e96b4ce9597469be5e6e84a9)

**Date**: 2025-12-16 15:20:01
...
|--------|-------|-----------|--------|
| Score Flatness | 0.034 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.014 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.012702841949118304 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.004592253954406211 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.940 |
| TopK vs Random Gap | 0.816 |
