...
**Seed Track**: Aaliyah - Rock The Boat (89f67bd19c13c2c481bd583206ce44d9)

**Date**: 2025-12-16 14:29:13
...
|--------|-------|-----------|--------|
| Score Flatness | 0.045 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.017 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.014503743684642134 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.028653710842685975 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.347 |
| TopK vs Random Gap | 0.707 |
