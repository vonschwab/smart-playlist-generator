...
**Seed Track**: Aphex Twin - #4 (62691d38ceb5d153cbc21ed11e77c054)

**Date**: 2025-12-16 14:29:16
...
|--------|-------|-----------|--------|
| Score Flatness | 0.017 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.012 | >= 0.15 | FAIL |
| Intra-Artist Coherence | -0.0049384891730740454 | >= 0.05 | FAIL |
| Intra-Album Coherence | -0.011601687476031186 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 2.119 |
| TopK vs Random Gap | 0.840 |
