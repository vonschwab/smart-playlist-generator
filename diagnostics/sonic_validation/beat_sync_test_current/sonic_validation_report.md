...
|--------|-------|-----------|--------|
| Score Flatness | 0.007 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.000 | >= 0.15 | FAIL |
| Intra-Artist Coherence | N/A | >= 0.05 | PASS |
| Intra-Album Coherence | N/A | >= 0.08 | PASS |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.197 |
| TopK vs Random Gap | 0.000 |
...
Sonic similarity is NOT informative (2/4 metrics pass). The validation metrics show:
