...
**Seed Track**: Jay Reatard - It's So Easy (4afa1f98bfd3bc9c108f131584cd0532)

**Date**: 2025-12-16 14:29:23
...
|--------|-------|-----------|--------|
| Score Flatness | 0.053 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.020 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.034073136174754715 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.012922979662327028 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.356 |
| TopK vs Random Gap | 0.550 |
