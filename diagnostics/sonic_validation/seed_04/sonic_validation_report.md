...
**Seed Track**: Beach House - Once Twice Melody (370b83ca5f025ddf99d67c885df37cef)

**Date**: 2025-12-16 14:29:21
...
|--------|-------|-----------|--------|
| Score Flatness | 0.028 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.013 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.015808580004593953 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.00025588451708102866 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.286 |
| TopK vs Random Gap | 0.548 |
