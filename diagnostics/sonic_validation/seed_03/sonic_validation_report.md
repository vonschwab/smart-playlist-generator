...
| Intra-Artist Coherence | 0.014553438404464325 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.006063364194512033 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 1.590 |
| TopK vs Random Gap | 0.655 |
