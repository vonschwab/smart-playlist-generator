...
|--------|-------|-----------|--------|
| Score Flatness | 0.044 | >= 0.5 | FAIL |
| TopK vs Random Gap | 0.018 | >= 0.15 | FAIL |
| Intra-Artist Coherence | 0.020871822669787488 | >= 0.05 | FAIL |
| Intra-Album Coherence | 0.006512644820898972 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 2.167 |
| TopK vs Random Gap | 0.807 |
