...
| TopK vs Random Gap | 0.009 | >= 0.15 | FAIL |
| Intra-Artist Coherence | -0.004968871542413433 | >= 0.05 | FAIL |
| Intra-Album Coherence | -0.0007703176082544116 | >= 0.08 | FAIL |

### Genre-Only Nearest Neighbors

| Metric | Value |
|--------|-------|
| Score Flatness | 0.000 |
| TopK vs Random Gap | 0.962 |
