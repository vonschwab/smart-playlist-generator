...
class PierBridgeConfig:
    ...
    # 70s leaves headroom under the 90s hard ceiling for pre-build overhead
    # (pool build, Last.fm recency). Expose as playlists.pier_bridge.generation_budget_s
    # in config.yaml.
    generation_budget_s: float = 70.0
