...
def _get_tower_weights() -> tuple[float, float, float]:
    """
    Return (rhythm, timbre, harmony) weights for tower_weighted.
    Override via SONIC_TOWER_WEIGHTS="0.2,0.5,0.3".
    """
    default = (0.2, 0.5, 0.3)
...
def _get_tower_pca_dims() -> tuple[int, int, int]:
    """
    Return (rhythm, timbre, harmony) PCA component counts for tower_pca.
    Override via SONIC_TOWER_PCA="8,16,8".
    """
    default = (8, 16, 8)
